function [uzk2,stres1,stres2,stres3,stres4,stres5,stres6]=Mnoddispdiv1_stress(kj,k1,w,nodes1,cinf,elements1,properinf1,nodinf1,K0f,K1f,K2f,K3f,K4f,K5f,Mf,Kr,F,no,elestrain,properties1)
   ...
   for s=1:length(kj);
        ...
        stres1(s,:) = stre1;   % size of strain or stress is (k1, length(elastrain)), i.e., k by z
        stres2(s,:) = stre2;
        stres3(s,:) = stre3;
        stres4(s,:) = stre4;
        stres5(s,:) = stre5;
