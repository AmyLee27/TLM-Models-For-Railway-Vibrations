function [epsilon,sigma]=volu7s(x,u,du,E,nu)
...
for iXi=1:nXi
  ...
  epsilon(1,iXi) = DN1(1)*u(1)+DN2(1)*u(4)+DN3(1)*u(7)+DN4(1)*u(10)+DN5(1)*u(13)+DN6(1)*u(16)+DN7(1)*u(19); % epsilon_xx
  epsilon(2,iXi) = du(2)+du(5)+du(8)+du(11)+du(14)+du(17)+du(20); %strain yy
  epsilon(3,iXi)=DN1(2)*u(3)+DN2(2)*u(6)+DN3(2)*u(9)+DN4(2)*u(12)+DN5(2)*u(15)+DN6(2)*u(18)+DN7(2)*u(21);  %epsilon_zz
  epsilon(4,iXi)= DN1(1)*u(2)+DN2(1)*u(5)+DN3(1)*u(8)+DN4(1)*u(11)+DN5(1)*u(14)+DN6(1)*u(17)+DN7(1)*u(20)+du(1)+du(4)+du(7)+du(10)+du(13)+du(16)+du(19);% strain xy
  epsilon(5,iXi)=DN1(1)*u(3)+DN2(1)*u(6)+DN3(1)*u(9)+DN4(1)*u(12)+DN5(1)*u(15)+DN6(1)*u(18)+DN7(1)*u(21)+DN1(2)*u(1)+DN2(2)*u(4)+DN3(2)*u(7)+DN4(2)*u(10)+DN5(2)*u(13)+DN6(2)*u(16)+DN7(2)*u(19);  %epsilon_xz
  epsilon(6,iXi)=du(3)+du(6)+du(9)+du(12)+du(15)+du(18)+du(21)+DN1(2)*u(2)+DN2(2)*u(5)+DN3(2)*u(8)+DN4(2)*u(11)+DN5(2)*u(14)+DN6(2)*u(17)+DN7(2)*u(20);  % strain yz                                        %epsilon_zy 
