...
function [feNod,feElt,feTyp,feMat,feSec,T1,t1,nodemaster,P]=asphalt_track_8nodes_PAC(width_t,bl_s,h_s,bu_s,z0_s,n1_s,n2_s,h_b,bu_b,bl_b,n2_b,n1_b,n2_a,n1_a,h_a,rho_s,Ezz_s,nu_s,...
...
% feElt_rp=[1+nElt_s+nElt_b+nElt_a+nElt_usl+nElt_sl 7 7 7 feNod_rp(1,1) feNod_rp(2,1) feNod_rp(3,1) feNod_rp(8,1) feNod_rp(13,1) feNod_rp(12,1) feNod_rp(11,1) feNod_rp(7,1);
%     2+nElt_s+nElt_b+nElt_a+nElt_usl+nElt_sl 7 7 7 feNod_rp(4,1) feNod_rp(5,1) feNod_rp(6,1) feNod_rp(10,1) feNod_rp(16,1) feNod_rp(15,1) feNod_rp(14,1) feNod_rp(9,1)];
...
if rail_type==1
    ...
    feNod_r(1:nNod_r,1)=feNod_r(1:nNod_r,1)+nNod_s+nNod_a+nNod_b+nNod_usl+nNod_sl+nNod_rp;
    ...
    feElt_r=[1+nElt_s+nElt_b+nElt_a+nElt_usl+nElt_sl+nElt_rp 8 8 8 feNod_r(1,1) feNod_r(3,1) feNod_r(13,1) feNod_r(11,1) feNod_r(2,1) feNod_r(8,1) feNod_r(12,1) feNod_r(7,1);
    2+nElt_s+nElt_b+nElt_a+nElt_usl+nElt_sl+nElt_rp 8 8 8 feNod_r(4,1) feNod_r(6,1) feNod_r(16,1) feNod_r(15,1) feNod_r(5,1) feNod_r(10,1) feNod_r(15,1) feNod_r(9,1);
    3+nElt_s+nElt_b+nElt_a+nElt_usl+nElt_sl+nElt_rp 8 8 8 feNod_r(11,1) feNod_r(13,1) feNod_r(23,1) feNod_r(21,1) feNod_r(12,1) feNod_r(18,1) feNod_r(22,1) feNod_r(17,1);
    4+nElt_s+nElt_b+nElt_a+nElt_usl+nElt_sl+nElt_rp 8 8 8 feNod_r(14,1) feNod_r(16,1) feNod_r(26,1) feNod_r(24,1) feNod_r(15,1) feNod_r(20,1) feNod_r(25,1) feNod_r(19,1);
];
...
if rail_type==1 % solid element
    % commented out the part when 7 node element is used
    feTyp={1 'volu8';2 'volu8';3 'volu8';4 'volu8'; 5 'volu8';6 'volu8'; 7 'volu8'; 8 'volu8'};
%     feTyp={1 'volu8';2 'volu8';3 'volu8';4 'volu8'; 5 'volu8';6 'volu8'; 7 'volu8'};
...
%     feTyp={1 'volu8';2 'volu7';3 'volu8';4 'volu8'; 5 'volu8';6 'volu8';7 'volu8';8 'beam1'};
    feTyp={1 'volu8';2 'volu8';3 'volu8';4 'volu8'; 5 'volu8';6 'volu8';7 'beam1'};
    
    feSec=[7 A_r Ixx_r Izz_r];
    feMat=[1 Ezz_s nu_s rho_s;
    2 Ezz_a nu_a rho_a;
    3 Ezz_b nu_b rho_b;
    4 Ezz_usl nu_usl rho_usl;
    5 Ezz_sl nu_sl rho_sl;
    6 Ezz_rp nu_rp rho_rp;
    7 E_r 0 rho_r];
...
if rail_type==1
    P(end-dofs)=1;
    P(end-4*dofs)=1; % depends on the dof, (en3-2)*nof+nof
