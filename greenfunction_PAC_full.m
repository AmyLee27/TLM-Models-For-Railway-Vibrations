function [uxk,strt1,strt2,strt3,strt4,strt5,strt6,uyk,uzk,stress1,stress2,stress3,stress4,stress5,stress6]=greenfunction_PAC_full(k1,k2,cinf,f,v,nodes1,elements1,properties1,properinf1,dir)
...
parfor j=1:length(ki);
   ...
   [uzk2,uyk2,uxk2,str1,str2,str3,str4,str5,str6,stres1,stres2,stres3,stres4,stres5,stres6]=Mnoddispdiv1_PAC_stress(kj,k1,w,nodes1,cinf,elements1,properinf1,nodinf1,K0f,K1f,K2f,K3f,K4f,K5f,Mf,Kr,F,no,elestrain,properties1);
